...
class OpenAI(BaseLLM):
    ...
    def call_openai(self,model_name,messages,*,temperature,sample,max_tokens):
        config = {
            "model": model_name,
...
class GPT_35(OpenAI):
    def __init__(self, *args, **kwargs):
        super().__init__(model='gpt-3.5-turbo-0125', *args, **kwargs)


class GPT_4o(OpenAI):
    def __init__(self, *args, **kwargs):
        super().__init__(model='gpt-4o',*args, **kwargs)

class GPT_4o_mini(OpenAI):
    def __init__(self, *args, **kwargs):
        super().__init__(model='gpt-4o-mini',*args, **kwargs)

class GPT_4(OpenAI):
    def __init__(self, *args, **kwargs):
        super().__init__(model='gpt-4-turbo',*args, **kwargs)
